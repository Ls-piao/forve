...
const globalRoutes = [
    ...
    { path: '/index', component: _import('index'), name: 'index', meta: { title: '整体布局' } },
    { path: '/zrzy', component: _import('zrzy/home/index'), name: 'zrzy', meta: { title: '自然资源' } },
    { path: '/tdly', component: _import('zrzy/tdly/index'), name: 'tdly', meta: { title: '土地利用' } },
    { path: '/kcjc', component: _import('zrzy/kcjc/index'), name: 'kcjc', meta: { title: '矿场监测' } },
    { path: '/zxzbjc', component: _import('zrzy/zxzbjc/index'), name: 'zxzbjc', meta: { title: '珍惜植被监测' } }
]
...
router.beforeEach((to, from, next) => {
    ...
    if (!token || !/\S/.test(token)) { // token为空，跳转到login登录
        ...
        fnAddDynamicMenuRoutes(configData.treeData)
        router.options.isAddDynamicMenuRoutes = true
        sessionStorage.setItem('allMenuList', JSON.stringify(configData.treeData || '[]'))
