  ...
  <div class="container">
    <div class="page-header">
      <el-form class="searchbox" :inline="true">
        ...
        <el-form-item>
          <el-input placeholder="行政区" v-model="outParams.suozaixingzhengqu" size="mini"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input placeholder="矿产代码" v-model="outParams.zhuyaokuangchan" size="mini"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input placeholder="矿产名称" v-model="outParams.zhuyaokcmingcheng" size="mini"></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="tableBox">
     ...
     <el-upload
          class="uploadBtn"
          :action="
            `${this.$http.BASE_URL}/hby/ziyuankanchaqu/zykanchaqu/import`
          "
...
import addDialog from './addArea'
import viewDialog from './viewArea'
export default {
  name: '',
  components: {
    addDialog,
  ...
  methods: {
    initData () {
      return this.$http({
        url: '/hby/ziyuankanchaqu/zykanchaqu/list',
    ...
    exportData () {
      this.$http({
        method: 'get',
        url: '/hby/ziyuankanchaqu/zykanchaqu/export',
        responseType: 'blob'
      })
        .then(response => {
          if (!response) {
    ...
    dels (items) {
      ...
      this.$http
        .delete('/hby/ziyuankanchaqu/zykanchaqu/delete', {
          params: { ids }
        })
        .then(({ data }) => {
          if (data.code === 200) {
