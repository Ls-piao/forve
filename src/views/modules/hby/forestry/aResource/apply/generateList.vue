  ...
  <div class="page">
    ...
    >
      <el-row>
        <el-button
          v-if="
            $route.query.previewMode || hasPermission(`form:${tableName}:add`)
          "
          type="primary"
          size="small"
          icon="el-icon-plus"
        ...
        <el-button
          v-if="
            $route.query.previewMode || hasPermission(`form:${tableName}:edit`)
          "
          type="warning"
          size="small"
        ...
        <el-button
          v-if="
            $route.query.previewMode || hasPermission(`form:${tableName}:del`)
          "
          type="danger"
          size="small"
          icon="el-icon-delete"
        ...
        <el-button-group class="pull-right">
          <el-button
            v-if="
              $route.query.previewMode ||
                hasPermission(`form:${tableName}:import`)
            "
            type="default"
            size="small"
...
import TreeSelectText from '@/views/modules/form/TreeSelectText.vue'
    ...
    check (v) {
      this.$confirm(`请选择提交选项`, '提交', {
        ...
        this.$http({
          ...
          method: 'post',
          data: { formId: this.$route.query.id, data: JSON.stringify(v) }
        }).then(({ data }) => {
          this.loading = false
