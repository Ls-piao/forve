        ...
        <div class="itemview addobject">
          <div class="formitem">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="动物类型" prop="DWLX">
                  <el-input
                    v-model="form.DWLX"
                    size="small"
                    placeholder="请输入动物类型"
              ...
              <el-col :span="8">
                <el-form-item label="天气状况" prop="TQZK">
                  <el-input
                    v-model="form.TQZK"
                    size="small"
                    placeholder="请输入天气状况"
              ...
              <el-col :span="8">
                <el-form-item label="调查起始时间" prop="DCQSSJ">
                  <el-input
                    v-model="form.DCQSSJ"
                    size="small"
              ...
              <el-col :span="8">
                <el-form-item label="调查结束时间" prop="DCJSSJ">
                  <el-input
                    v-model="form.DCJSSJ"
                    size="small"
              ...
              <el-col :span="8">
                <el-form-item label="中文名" prop="ZWM">
                  <el-input
                    v-model="form.ZWM"
                    size="small"
                    placeholder="请输入中文名"
