  ...
  <div class="container">
    <div class="page-header">
      <el-form class="searchbox" :inline="true">
        <el-form-item>
          <el-input placeholder="标识码" v-model="outParams.biaoshima" size="mini"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input placeholder=" 湿地斑块编码" v-model="outParams.sdbk" size="mini"></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="tableBox">
      <div class="listbar">
       ...
       <el-upload
          class="uploadBtn"
          :action="`${this.$http.BASE_URL}/hby/animal/animal/import`"
...
<script>
import addDialog from './addAnimal'
import { cloneDeep } from 'lodash'
import viewDialog from './viewAnimal'
export default {
  name: '',
  components: {
    addDialog,
  ...
  methods: {
    ...
    dels (items) {
      ...
      this.$http
        .delete('/hby/animal/animal/delete', {
          params: { ids }
        })
        .then(({ data }) => {
          if (data.code === 200) {
