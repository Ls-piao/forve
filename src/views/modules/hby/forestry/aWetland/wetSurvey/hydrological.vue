  ...
  <div class="container">
    <div class="page-header">
      <el-form class="searchbox" :inline="true">
        ...
        <el-form-item>
          <el-input placeholder="湿地斑块编码" v-model="outParams.shidibankuai" size="mini"></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="tableBox">
      <div class="listbar">
        ...
        >
         <el-upload
          class="uploadBtn"
          :action="`${this.$http.BASE_URL}/hby/shuiwendc/shuiwen/import`"
...
export default {
  ...
  methods: { initData () {
    return this.$http({
      url: '/hby/shuiwendc/shuiwen/list',
    ...
    exportData () {
      this.$http({
        method: 'get',
        url: '/hby/shuiwendc/shuiwen/export',
        responseType: 'blob'
      }).then(response => {
        if (!response) {
          return
    ...
    dels (items) {
      ...
      this.$http
        .delete('/hby/shuiwendc/shuiwen/delete', {
          params: { ids }
        })
        .then(({ data }) => {
          if (data.code === 200) {
