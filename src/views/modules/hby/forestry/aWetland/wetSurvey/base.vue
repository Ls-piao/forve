  ...
  <div class="container">
    <div class="page-header">
      <el-form class="searchbox" :inline="true">
        <el-form-item>
          <el-input placeholder="标识码" v-model="outParams.bsnum" size="mini"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input placeholder="湿地斑块编码" v-model="outParams.sdbianhao" size="mini"></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="tableBox">
      <div class="listbar">
        ...
        <el-upload
          class="uploadBtn"
          :action="`${this.$http.BASE_URL}/hby/jcortr/jcortr/import`"
...
<script>
import addDialog from './addBase'
import { cloneDeep } from 'lodash'
import viewDialog from './viewBase'
export default {
  name: '',
  components: {
    addDialog,
  ...
  methods: {
    ...
    dels (items) {
      ...
      this.$http
        .delete('/hby/jcortr/jcortr/delete', {
          params: { ids }
        })
        .then(({ data }) => {
          if (data.code === 200) {
