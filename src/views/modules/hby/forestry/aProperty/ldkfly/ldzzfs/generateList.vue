...
:min-width="getWidth(option.model)">
      ...
      <el-table-column
        ...
        <template  slot-scope="scope">
          ...
          <el-button v-if="$route.query.previewMode || hasPermission(`form:${tableName}:del`)" type="text" size="mini" icon="el-icon-check"  @click="del(scope.row)">
            审核
          </el-button>
