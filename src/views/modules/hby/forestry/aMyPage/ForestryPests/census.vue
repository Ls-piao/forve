    ...
    <div class="top" v-if="show">
      <div class="top-item">
        <div class="data">
          ...
          <div class="right">
            <div class="num"><animateInteger :value="topData.lyzh" /></div>
      ...
      <div class="top-item">
        <div class="data">
          ...
          <div class="right">
            <div class="num"><animateInteger :value="topData.slhz" /></div>
      ...
      <div class="top-item">
        <div class="data">
          ...
          <div class="right">
            <div class="num"><animateInteger :value="topData.bcz" /></div>
      ...
      <div class="top-item">
        <div class="data">
          ...
          <div class="right">
            <div class="num"><animateInteger :value="topData.ysdw" /></div>
    ...
    <div class="content">
      <div class="top">
        ...
        <div class="top-right">
          <div class="title">
            <div>总计受灾面积:</div>
            <div class="num"><animateInteger :value="zmj||0" />㎡</div>
          </div>
          <Pie2 id="pie2" v-if="show" :data="PieData" />
        </div>
      </div>
      <div class="bottom">
        <div class="bottom-left">
          ...
          <div class="chart">
            <Line1 id="line1" v-if="show" :data="monthData" />
          </div>
        </div>
        <div class="bottom-right">
          <div class="title">每年发生的灾害次数</div>
          <div class="chart">
            <Bar id="bar1" v-if="show" :data="BarData" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    initData () {
      this.$http({
        url: '/hbylyyh/lyyh/indexData',
        method: 'get'
      }).then(({data}) => {
        this.topData.lyzh = data.data.lyzh
