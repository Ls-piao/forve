    ...
    <div class="jp-common-layout-center jp-flex-main">
      <el-form :inline="true" size="small" class="query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
         ...
         <el-form-item prop="typeNo.id" label="类别">
          ...
          <el-form-item label="部门" prop="responsibilityDept.id"
                        :rules="[
                 ]">
            <SelectTree
              ref="responsibilityDept"
              :props="{
                          value: 'id',             // ID字段名
                          label: 'name',         // 显示名称
                          children: 'children'    // 子级字段名
              ...
              :value="searchForm.responsibilityDept.id"
              :clearable="true"
              :accordion="true"
              @getValue="(value) => {searchForm.responsibilityDept.id=value}"/>
          </el-form-item>
...
<script>
  import BgxtGdzcInfoForm from '../zcfl/BgxtGdzcInfoForm'
  import BgxtGdzcEditForm from '../zcfl/BgxtGdzcEditForm'
  import BgxtGdzcSortForm from '../zcfl/BgxtGdzcSortForm'
  import SelectTree from '@/components/treeSelect/treeSelect.vue'
  import DataRecord from '@/views/modules/hby/oa/assets/ypgl/ypwh/DataRecord'
  import BgxtGdzcRecord from '../zcfl/BgxtGdzcRecord'
export default {
    data () {
      return {
        searchForm: {
