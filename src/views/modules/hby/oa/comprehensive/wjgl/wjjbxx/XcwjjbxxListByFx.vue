...
<!--            <el-button v-if="hasPermission('wjjbxx:xcwjjbxx:import')" type="default" size="small" icon="el-icon-upload2" title="导入" @click="isImportCollapse = !isImportCollapse"></el-button>
            <el-button v-if="hasPermission('wjjbxx:xcwjjbxx:export')" type="default" size="small" icon="el-icon-download" title="导出" @click="exportExcel()"></el-button>-->
            <el-button
              type="default"
              size="small"
    ...
    <el-table-column
        ...
        label="问卷编码">
            <template slot-scope="scope">
              ...
              <el-link  type="primary" :underline="false" v-else-if="hasPermission('wjjbxx:xcwjjbxx:view')"  @click="view(scope.row.id)">{{scope.row.wjbm}}</el-link>
    ...
    <el-table-column
      ...
      <el-table-column
        ...
        label="操作">
        <template  slot-scope="scope">
<!--          <el-button v-if="hasPermission('wjjbxx:xcwjjbxx:view')" type="text" icon="el-icon-view" size="small" @click="view(scope.row.id)">查看</el-button>
          ...
          <el-button  type="text"  icon="fa fa-cloud" size="small" @click="showRight(scope.row)">问卷分析</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <XcwjjbxxForm  ref="xcwjjbxxForm" @refreshDataList="refreshList"></XcwjjbxxForm>
      <el-drawer
        ...
        direction="rtl">
        <xc-wjybjl-list  :wjbtname="wjbtname" ref="xcWjybjlList" @closeRight="closeRight"></xc-wjybjl-list>
      </el-drawer>
...
<script>
  ...
  import XcWjybjlList from '../wjybjl/XcWjybjlList'
  export default {
    data () {
      return {
        searchForm: {
    ...
    // 排序
      ...
      // 查看
      view (id) {
        this.$refs.xcwjjbxxForm.init('view', id)
      },
      // 删除
      del (id) {
      ...
      showRight (row) {
        ...
        this.$nextTick(() => {
          this.$refs.xcWjybjlList.refreshList(row.id)
