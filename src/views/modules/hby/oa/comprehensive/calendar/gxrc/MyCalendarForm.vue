  ...
  <div>
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="success" v-if="this.inputForm.state === '0' && this.gxjb === '1'" @click="wc">完成</el-button>
