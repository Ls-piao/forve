...
<!--        <el-input v-model="searchForm.procDefNameSearch" size="small" placeholder="请输入流程名称"></el-input>-->
<!--      </el-form-item>-->
      <el-form-item>
        <el-button  type="primary" @click="refreshList()" size="small">查询</el-button>
        <!--          <el-button @click="resetSearch()" size="small">刷新</el-button>-->
      </el-form-item>
    </el-form>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="todo(scope.row)">审批</el-button>
  ...
  watch: {
    searchDates () {
      if (this.searchDates) {
        ...
        this.searchForm.procDefNameSearch = this.procDefNameSearch
      } else {
        this.searchForm.beginDate = ''
        this.searchForm.endDate = ''
        this.searchForm.procDefNameSearch = ''
      }
    }
  },
  methods: {
