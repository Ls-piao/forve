        ...
        <el-row  :gutter="15">
          <el-col :span="24">
            <el-form-item label="会议主题" prop="hyzt"
              ...
              <el-input v-model="inputForm.hyzt" placeholder="请填写会议主题"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="参会方式" prop="chfs"
                          :rules="[{required: true, message:'请选择参会方式', trigger:'blur'}]">
              <el-radio-group v-model="inputForm.chfs">
          ...
          <el-col :span="24">
            <el-form-item label="会议室" prop="hysid"
              ...
              <el-select v-model="inputForm.hysid" placeholder="请选择" style="width: 100%">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item label="会议类型" prop="hylxid"
              ...
              <el-select v-model="inputForm.hylxid" placeholder="请选择"  style="width: 100%;">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item label="会议签到" prop="sfqyhyqd"
              ...
              <el-radio-group v-model="inputForm.sfqyhyqd">
...
<!--              <el-input v-model="inputForm.hytxsj" placeholder="请填写会议提醒时间"></el-input>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
          <el-col :span="24">
            <el-form-item label="参加人员" prop="cjry"
                          :rules="[{required: true, message:'请选择参加会议人员', trigger:'blur'}]">
              <user-select size="small" placeholder="请选择参加会议人员" :value="inputForm.cjry" @getValue='(value) => {inputForm.cjry=value}'></user-select>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<!--              <el-radio-group v-model="inputForm.cjkhtxfs">-->
...
<!--          </el-col>-->
          <el-col :span="24">
            <el-form-item label="其他参加" prop="qtcj"
                          :rules="[]">
              <el-input type="textarea" v-model="inputForm.qtcj" placeholder="请填写其他参加"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
      ...
      <el-button size="small" type="primary" v-if="method != 'view'" @click="doSubmit('2')" v-noMoreClick>确定</el-button>
    </span>
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    init (method, id) {
      ...
      this.$nextTick(() => {
        ...
        // 获取会议类型
        this.$http({
          url: `/zxsq/flb/xcBgzxLjfl/treeData?flag=4`,
          method: 'get'
        }).then(({data}) => {
