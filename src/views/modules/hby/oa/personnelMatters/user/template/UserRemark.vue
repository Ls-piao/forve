<template>
  <el-dialog :title="title" :close-on-click-modal="false" v-dialogDrag :visible.sync="visible">
    <el-form size="small" :model="inputForm" ref="inputForm" :class="method==='view'?'readonly':''"
      ...
      <el-row :gutter="15">
        <el-col :span="12">
          <el-form-item label="类型" prop="remarkType" :rules="[]">
            <el-input v-model="inputForm.remarkType" maxlength="10" placeholder=""></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="内容" prop="remarkDetail" :rules="[]">
            <el-input type="textarea" v-model="inputForm.remarkDetail" placeholder="请填写备注信息"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
