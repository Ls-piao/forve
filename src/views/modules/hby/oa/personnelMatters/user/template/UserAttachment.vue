<template>
  <el-dialog :title="title" :close-on-click-modal="false" v-dialogDrag :visible.sync="visible">
    <el-form size="small" :model="inputForm" ref="inputForm" :class="method==='view'?'readonly':''"
      ...
      <el-row :gutter="15">
        <el-col :span="12">
          <el-form-item label="附件类型" prop="attType" :rules="[]">
            <el-input v-model="inputForm.attType" maxlength="10" placeholder=""></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="附件文件名" prop="attName" :rules="[]">
            <el-input v-model="inputForm.attName" maxlength="10" placeholder=""></el-input>
          </el-form-item>
        </el-col>
        <p>TODO 缺附件上传控件</p>
        <el-col :span="12">
