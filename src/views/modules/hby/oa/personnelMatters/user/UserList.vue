      ...
      <div class="jp-common-el-tree-scrollbar el-scrollbar">
        <div class="el-scrollbar__wrap">
          <div class="el-scrollbar__view">
            <el-tree class="filter-tree jp-common-el-tree" :render-content="renderContent" :data="officeTreeData"
              :props="{
                    value: 'id',             // ID字段名
                    label: 'name',         // 显示名称
    ...
    <div class="jp-common-layout-center jp-flex-main">
      ...
      <el-dialog title="导入Excel" :visible.sync="isImportCollapse">
        <el-form size="small" :inline="true" ref="importForm">
          ...
          <el-form-item prop="loginName">
            <el-upload class="upload-demo" :action="`${this.$http.BASE_URL}/sys/user/import`"
              :on-success="handleSuccess" :before-upload="beforeUpload" :show-file-list="true">
      ...
      <div class="bg-white top">
        <el-row>
          ...
          <el-button-group class="pull-right">
            <el-tooltip class="item" effect="dark" content="导入" placement="top">
              <el-button type="default" size="small" icon="el-icon-upload2" title="导入"
                @click="isImportCollapse = !isImportCollapse"></el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="导出" placement="top">
              <el-button type="default" size="small" icon="el-icon-download" title="导出" @click="exportExcel()">
              </el-button>
            </el-tooltip>
        ...
        <el-table :data="dataList" v-loading="loading" @selection-change="selectionChangeHandle"
          @sort-change="sortChangeHandle" size="small" height="calc(100% - 80px)" class="table">
          <el-table-column type="selection" header-align="center" align="center" width="50">
          </el-table-column>
          <el-table-column type="index" header-align="center" align="center" width="50" label="#">
          </el-table-column>
          <el-table-column prop="jobNum" sortable="custom" min-width="100" show-overflow-tooltip label="工号">
          </el-table-column>
          <el-table-column prop="name" sortable=false min-width="100" show-overflow-tooltip label="员工姓名">
          </el-table-column>
          <el-table-column prop="office.name" sortable="custom" min-width="120" show-overflow-tooltip label="部门">
          </el-table-column>
          <el-table-column prop="post.name" sortable="custom" show-overflow-tooltip min-width="80" label="岗位">
          </el-table-column>
          <el-table-column prop="sex" sortable="custom" show-overflow-tooltip min-width="80" label="性别">
            <template slot-scope="scope">
              {{ $dictUtils.getDictLabel("RSGL_sexType", scope.row.sex, '-') }}
            </template>
          </el-table-column>
          <el-table-column prop="birthDate" sortable="custom" show-overflow-tooltip min-width="80" label="出生日期">
          </el-table-column>
          <el-table-column prop="ethnic" sortable="custom" show-overflow-tooltip min-width="80" label="民族">
            <template slot-scope="scope">
              {{ $dictUtils.getDictLabel("RSGL_ethnic", scope.row.ethnic, '-') }}
            </template>
          </el-table-column>
          <el-table-column prop="hometown" sortable="custom" show-overflow-tooltip min-width="80" label="籍贯">
          </el-table-column>
          ...
          <el-table-column fixed="right" :key="Math.random()" header-align="center" align="center" width="200"
            label="操作">
            <template slot-scope="scope">
