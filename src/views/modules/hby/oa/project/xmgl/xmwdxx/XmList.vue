<template>
  <div class="page">
    ...
    <el-table-column
      ...
      <el-table-column
        ...
        <template  slot-scope="scope">
          ...
          <el-button type="text"  icon="el-icon-view" size="small" @click="xmwd(scope.row)">项目文档</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <WdxxList  ref="WdxxList" ></WdxxList>
  </div>
</template>

<script>
  import XmjbxxForm from './XmForm'
  import WdxxList from './WdxxList'
...
export default {
    ...
    methods: {
      ...
      xmwd (row) {
        this.$refs.WdxxList.xmid = row.id
        this.$refs.WdxxList.refreshList()
        this.$refs.WdxxList.visible = true
      },
      // 获取数据列表
      refreshList () {
        this.loading = true
