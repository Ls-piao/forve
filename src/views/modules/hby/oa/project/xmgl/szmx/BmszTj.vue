<template>
    <div class="page">
      <el-form size="small" :inline="true" class="query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
         ...
         <el-form-item prop="office.name">
            <el-input size="small" v-model="searchForm.office.name" placeholder="部门" clearable></el-input>
         </el-form-item>
