    ...
    <el-table-column
      ...
      <el-table-column
        ...
        <template  slot-scope="scope">
          ...
          <el-button type="text" v-if="'4' ===scope.row.xmzt"  icon="el-icon-view" size="small" @click="rwtb(scope.row)">任务查看</el-button>
          <el-button type="text" v-if="scope.row.rwStatus === '1' && hasPermission('xmgl:xmxx:xmjbxx:xmwc')"  icon="el-icon-edit" size="small" @click="xmwc(scope.row)">项目完成</el-button>
          <el-button type="text" v-if="scope.row.rwStatus === '2' && hasPermission('xmgl:xmxx:xmjbxx:xmcq')"  icon="el-icon-edit" size="small" @click="xmcq(scope.row)">项目重启</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
    ...
    methods: {
      ...
      refreshList () {
        ...
        this.$http({
          url: '/xmgl/xmxx/xmjbxx/list?xmzt=4',
          method: 'get',
          params: {
            'pageNo': this.pageNo,
