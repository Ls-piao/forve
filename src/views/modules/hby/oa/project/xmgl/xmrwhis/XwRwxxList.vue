    ...
    <div class="page">
      <el-form size="small" :inline="true" class="query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
        ...
        <el-form-item prop="bbh">
          <el-select v-model="searchForm.bbh" style="width:100%" placeholder="版本号">
              <el-option
                v-for="xmHistory in bbhList"
                :key="xmHistory.bbh"
                :label="xmHistory.bbh"
                :value="xmHistory.bbh">
              </el-option>
  ...
  export default {
    ...
    methods: {
      ...
      refreshList () {
        ...
        this.$http({
          url: '/xmgl/xmrwhis/xmHistory/bbhList?xmId.id=' + this.xmid + '&pageNo=1&pageSize=-1',
          method: 'get'
        }).then(({data}) => {
          this.bbhList = data.list
          this.searchForm.bbh = data.list[0].bbh
        })
        this.$http({
