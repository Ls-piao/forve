    ...
    <el-table-column
      ...
      <el-table-column
        ...
        <template  slot-scope="scope">
          ...
          <el-button type="text" v-if="'4' ===scope.row.xmzt"  icon="el-icon-view" size="small" @click="rwfj(scope.row)">任务分解</el-button>
          <el-button type="text" v-if="'4' ===scope.row.xmzt && '1' != scope.row.rwStatus"  icon="el-icon-edit" size="small" @click="rwfb(scope.row)">任务发布</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
