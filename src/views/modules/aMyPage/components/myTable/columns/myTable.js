...
export default function (target) {
    return [
        ...
        { columnName: "plants_huoben", prop: "huoben", label: "活本图", align: "center", width: 100 ,render:function(h,c){
        ...
        { columnName: "plants_biaoben", prop: "biaoben", label: "标本图", align: "center", width: 100,render:function(h,c){
    ...
    { columnName: "forest_prospect", prop: "house", label: "受灾远景样片", align: "center", width: 100,render:function(h,c){
    ...
    { columnName: "forest_close", prop: "house", label: "受灾近景样片", align: "center", width: 100,render:function(h,c){
    ...
    { columnName: "human_del", fixed: "right",prop: "des", label: "记录操作", align: "center", width: 100 ,render:(h,c)=>{
        return (
            <div>
    ...
    { columnName: "human_control", fixed: "right",label: "视频操作", align: "center", width: 140, render:(h,c)=>{
