<template>
  <div class="container addobject">
    ...
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="中文种名" prop="CNzhongName">
        <el-input
          v-model="form.CNzhongName"
          placeholder="请输入中文种名"
        ></el-input>
      </el-form-item>
      <el-form-item label="中文科名" prop="CNkeName">
        <el-input
          v-model="form.CNkeName"
          placeholder="请输入中文科名"
        ></el-input>
      </el-form-item>
      <el-form-item label="中文属名" prop="CNshuName">
        <el-input
          v-model="form.CNshuName"
          placeholder="请输入中文属名"
        ></el-input>
      </el-form-item>
      <el-form-item label="拉丁种名" prop="ENzhongName">
        <el-input
          v-model="form.ENzhongName"
          placeholder="请输入拉丁种名"
        ></el-input>
      </el-form-item>
      <el-form-item label="拉丁科名" prop="ENkeName">
        <el-input
          v-model="form.ENkeName"
          placeholder="请输入拉丁科名"
        ></el-input>
      </el-form-item>
      <el-form-item label="拉丁属名" prop="ENshuName">
        <el-input
          v-model="form.ENshuName"
          placeholder="请输入拉丁属名"
        ></el-input>
      </el-form-item>

      <el-form-item label="濒危程度" prop="dangerType">
        <el-select v-model="form.dangerType" placeholder="请选择濒危程度">
          <el-option
      ...
      <el-form-item label="保护等级" prop="protectType">
        <el-select v-model="form.protectType" placeholder="请选择保护等级">
          <el-option
      ...
      <el-form-item label="分布地域" prop='area'>
        <el-select v-model="form.area" placeholder="请选择分布地域">
          <el-option
            v-for="v in areaConfig"
            :key="v.value"
            :label="v.label"
            :value="v.value"
          ></el-option>
      ...
      <el-form-item label="保护价值">
        <el-select v-model="form.area" placeholder="请选择保护价值">
          <el-option
